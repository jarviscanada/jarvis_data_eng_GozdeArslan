...
psql_password=$5
   ...
   #check # of CLI arguments
    if [ $# -ne 5 ]; then
      echo 'Error!Missing CLI arguments.'
      exit 1
    fi
   ...
   id="(SELECT id FROM host_info WHERE hostname='$hostname')";
    insert_stmt="INSERT INTO host_info(id, hostname ,cpu_number,cpu_architecture,cpu_model ,cpu_mhz,l2_cache, total_mem ,
                                       timestamp) VALUES(id, hostname ,cpu_number,cpu_architecture,cpu_model ,cpu_mhz,l2_cache, total_mem ,'$timestamp')";
